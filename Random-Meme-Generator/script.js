...
function clearAll() {
    const IfMeme = document.querySelector(".meme-class");
    const IfJoke = document.querySelector(".joke-class");
    const IfQuote = document.querySelector(".Quote-class");
    const Ifriddle = document.querySelector(".Riddle-class");
    IfMeme.innerHTML = "";
    IfJoke.innerHTML = "";
    IfQuote.innerHTML = "";
    Ifriddle.innerHTML = "";
...
function showMeme() {
  ...
  const MemeContainer = document.querySelector('.meme-class'); 
  const m = document.createElement('img'); 
  m.setAttribute('src',randomMemeUrl); 
  clearAll();
  MemeContainer.appendChild(m); 
}


function showJoke() {
  const randomJokeText = getRandomData("jokes");
  const JokeContainer = document.querySelector('.joke-class');
  const j = document.createElement('p');
  j.textContent = randomJokeText;
  clearAll();
  JokeContainer.appendChild(j);  
}

function showQuote() {
  const randomQuote = getRandomData("quotes");
  const QuoteContainer = document.querySelector('.Quote-class');
  const quote = document.createElement('p') , author = document.createElement('p');
  quote.textContent = "Quote :" + randomQuote.quote;
...
function showRiddle() {
  ...
  const QuestionContainer = document.querySelector('.Riddle-class');
  const questionEle = document.createElement('p'),answerEle=document.createElement('p');
  questionEle.textContent = question;
  answerEle.textContent = answer;
  answerEle.setAttribute("id","RiddleAnswer");
  clearAll();
  answerEle.hidden = true;
  QuestionContainer.appendChild(questionEle);
  QuestionContainer.appendChild(answerEle);
}


function revealAnswers() {

    const riddleContent = document.querySelector(".Riddle-class");
